# Resolve Completion sample for Text Editor

Demonstrates how to respond when `LspTextEditorLanguageRequestEvent.REQUEST_RESOLVE_COMPLETION` is dispatched by the `LspTextEditor` component.
